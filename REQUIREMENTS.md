...
- [x] [FILE-C-000] 基于 localStorage 的已知项目快速访问 #feature #P1.5
  - [x] [FILE-C-001] 在 `localStorage` 中记录已打开项目的历史工程列表（记录项目路径、文件夹名称、上次访问时间等）
  - [x] [FILE-C-002] 主界面提供“最近项目”的快捷入口，便于用户一键快速打开已知工程
  - [x] [FILE-C-003] 快速项目列表的界面设计待定（TBD），需支持快捷清除历史记录或单条移除
